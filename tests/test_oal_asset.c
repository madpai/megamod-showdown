...
int main(void)
{
    ...
    buf c = package("{\"kind\":\"character\",\"loadout\":[\"AK-47\",\"pistol\"],"
                    "\"name\":\"guy\",\"hero_group\":\"SUPERHERO\",\"unique_limit\":1,"
                    "\"ability_beam\":true}", 1, false);
    ...
    CHECK(!strcmp(ch.hero_group, "SUPERHERO") && ch.unique_limit == 1 && ch.ability_beam,
          "hero group, unique slot and beam setting read from the package");
