...
project** — `HANDOFF.md` carries everything that is still true. This is the
*why*: what was tried, what it looked like when it was wrong, and which tag
field turned out to be the answer.

Reach for it when you hit something that smells like it has been hit before,
...
# Older planning notes (2026-09-19, superseded)

Kept because the reasoning is still sound where the items are still open.
HANDOFF.md is the current list.
